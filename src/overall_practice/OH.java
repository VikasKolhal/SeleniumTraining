...
public class OH {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		s1.wait.until(ExpectedConditions.elementToBeClickable(By.name("username")));
		...
		s1.wait.until(
				ExpectedConditions.elementToBeClickable(By.cssSelector(".oxd-grid-2.orangehrm-full-width-grid input")));
		// WebElement employeeID =
		// driver.findElement(By.cssSelector(".oxd-grid-2.orangehrm-full-width-grid
		// input"));
		// Thread.sleep(5000);
		// employeeID.clear();
		// Thread.sleep(5000);
		...
		//
		s1.wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(
				".oxd-table-row.oxd-table-row--with-border.oxd-table-row--clickable>div:nth-of-type(2)>div")));
		s1.wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(
				".oxd-table-row.oxd-table-row--with-border.oxd-table-row--clickable>div:nth-of-type(2)>div")));
		// s1.wait.until(ExpectedConditions.elementToBeSelected(By.cssSelector".oxd-table-card>div>div:nth-of-type(2)>div")));
		// s1.wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(
		// ".oxd-table-card>div>div:nth-of-type(2)>div")));
		// s1.wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(
		// ".oxd-table-card>div>div:nth-of-type(2)>div")));
		...
		// WebElement element=driver.findElement(By.xpath("//div[@class='oxd-table-row
		// oxd-table-row--with-border oxd-table-row--clickable']/div[2]"));
		...
		s1.wait.until(ExpectedConditions.elementToBeClickable(
				By.cssSelector(".orangehrm-edit-employee-navigation>div:nth-of-type(2)>div:nth-of-type(6)>a")));
		driver.findElement(
				By.cssSelector(".orangehrm-edit-employee-navigation>div:nth-of-type(2)>div:nth-of-type(6)>a")).click();

		System.out.println("****click on select****");
		// s1.wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".orangehrm-edit-employee>div:nth-of-type(2)>div>form>div:nth-of-type(1)>div>div:nth-of-type(2)>div>div:nth-of-type(2)
		// i")));
		// s1.wait.until(ExpectedConditions.elementToBeSelected(By.cssSelector(".orangehrm-edit-employee>div:nth-of-type(2)>div>form>div:nth-of-type(1)>div>div:nth-of-type(2)>div>div:nth-of-type(2)
		// i")));
		...
		// s1.wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.cssSelector(".orangehrm-edit-employee>div:nth-of-type(2)
		// form>div:nth-of-type(1)>div>div:nth-of-type(2)>div>div:nth-of-type(2)>div
		// .oxd-select-dropdown>div")));
		Thread.sleep(10000);
		...
		for(WebElement e:jobList) {
			...
			s1.wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".orangehrm-edit-employee>div:nth-of-type(2) form>div:nth-of-type(1)>div>div:nth-of-type(2)>div>div:nth-of-type(2)>div .oxd-select-dropdown>div")));
			if(e.getText().equalsIgnoreCase("QA Lead")) {
				//jobList = driver.findElements(By.cssSelector(".orangehrm-edit-employee>div:nth-of-type(2) form>div:nth-of-type(1)>div>div:nth-of-type(2)>div>div:nth-of-type(2)>div .oxd-select-dropdown>div"));
				//s1.wait.until(ExpectedConditions.refreshed(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".orangehrm-edit-employee>div:nth-of-type(2) form>div:nth-of-type(1)>div>div:nth-of-type(2)>div>div:nth-of-type(2)>div .oxd-select-dropdown>div"))));
				s1.wait.until(ExpectedConditions.textToBePresentInElementValue(e, "QA Lead"));
				e.click();
		...
		/*
		 * if(jobList!=null) { for(int i=0;i<jobList.size();i++) {
		 * 
		 * jobList=driver.findElements(By.
		 * cssSelector(".orangehrm-edit-employee>div:nth-of-type(2) form>div:nth-of-type(1)>div>div:nth-of-type(2)>div>div:nth-of-type(2)>div .oxd-select-dropdown>div"
		 * )); if(jobList.get(i).getText().equals("QA Lead")) { jobList.get(i).click();
		 * System.out.println("QA Lead is present");
		 * 
		 * 
		 * // System.out.println("I is:"+i);
		 * 
		 * else { System.out.println("QA lead is not present");
		 * 
		 * }
		 * 
		 * // break; } } }
		...
		System.out.println("***click on search***");
		driver.findElement(By.cssSelector("button[type='submit']")).click();
       // s1.wait.until(ExpectedConditions.textToBe(By.cssSelector(".orangehrm-container>div>div:nth-of-type(2)>div>div>div:nth-of-type(5)"), "QA Lead"));
		//Thread.sleep(5000);
		...
		driver.manage().timeouts().pageLoadTimeout(30, TimeUnit.SECONDS);
		// s1.wait.until(ExpectedConditions.textToBePresentInElement(element, "QA
		// Lead"));
		...
		/// s1.wait.until(ExpectedConditions.textToBe(By.cssSelector(".orangehrm-horizontal-padding>span"),
		// "No Records Found"));
		// Thread.sleep(10000);
